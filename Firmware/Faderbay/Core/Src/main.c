...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, MUX_S3_Pin|MUX_S2_Pin|MUX_S1_Pin|MUX_S0_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MUX_S3_Pin MUX_S2_Pin MUX_S1_Pin MUX_S0_Pin */
  GPIO_InitStruct.Pin = MUX_S3_Pin|MUX_S2_Pin|MUX_S1_Pin|MUX_S0_Pin;
